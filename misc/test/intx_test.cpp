/**
 * $Id: intx_test.cpp 3 2013-05-20 13:07:23Z cota@upard.org $
...
int main() {
  {
    ...
    //    intX_t hex(
    //    "0xaaafffffeeeeefffab000119871032234211111111111111115555555555555555555444444442fffbbbbbbbbbc"
    //    );
    intX_t hex("0xa");
    cout << "hex: " << hex << endl;
    ...
    cout << "trap" << intX_t(2) << endl;
    for (int i = 0; i < 100000000; ++i) {
      cout << (val = val / intX_t(2)) << ": " << i << endl;
      if (val == intX_t(1)) {
        break;
      }
    }
