/**
 * $Id: hash_test.cpp 3 2013-05-20 13:07:23Z cota@upard.org $
...
class Test {
 ...
 public:
  explicit Test(const HashMap &hmap) : hmap(hmap) {}
  ...
  void func() {
    ...
    {
      HashMap::const_iterator it = hmap.begin(), endIt = hmap.end();
    ...
    HashMap::const_iterator cit = hmap.at("key1000022");
...
int main() {
  cout << "Is this good? " << cutil::hash("Is this good?") << endl;
  cout << "is this good? " << cutil::hash("is this good?") << endl;
  cout << "is this good? " << cutil::hash("is this good?") << endl;
  ...
  {
    HashMap::const_iterator it = hashmap.begin(), endIt = hashmap.end();
  ...
  HashMap::iterator cit = hashmap.at("key1000022");
