/**
 * $Id: UKF.h 3 2013-05-20 13:07:23Z cota@upard.org $
...
class UKF {
 ...
 public:
  /*!
    ...
    P0: 状態変数の分散の初期値
*/
  UKF(const CColumnVector<M> &x0, const CMatrix<M, M> &P0);
  ...
  */
  ...
  void update(const EVOLUTION_FUNC &F, const OBSERVE_FUNC &H,
              const CColumnVector<M> &Q, const CColumnVector<N> &R,
