...
int main() {
  ...
  cout << "FONT: size " << goth_font.getHeight() << ", nihoss" << goth_font.getWidth( "nihoss" ) << endl;
  ...
  surface.drawString( "This is test.",
                      goth_font,
                      color,
                      10, 20 );
  ...
  surface.drawString( "日本語をテストします.",
                      goth_font,
                      color,
                      10, 60 );

  surface.drawString( "テストです。",
                      goth_font,
                      color,
                      10, 100 );
