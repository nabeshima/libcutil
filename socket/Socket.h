...
class Socket {
 ...
 public:
  ...
  //! Only for IPv4 and IPv6 to TCP accept and UDP receive.
  //! If port == 0, random port is bound.
  bool bind(uint16_t port = 0, int backlog = 5);

  //! Only for Local to TCP accept and UDP receive.
  bool bind(const Address &local_socket_path, int backlog = 5);
  ...
  //! returns invalid address in case of Local TCP socket generated by accept();
